...
import economicsHero from "@/assets/economics-classroom-hero-v2.png";
...
export default function Register() {
  ...
  return (
    <div className="workspace flex min-h-screen bg-[var(--work-canvas)]">
      <section className="relative hidden min-h-screen w-1/2 overflow-hidden bg-[#203c32] md:flex">
        <img src={economicsHero} alt="ชั้นเรียนเศรษฐศาสตร์และการเรียนการสอน" className="absolute inset-0 h-full w-full object-cover object-[25%_center] brightness-[0.72] saturate-[0.82]" />
        ...
        <div className="relative z-10 flex w-full flex-col justify-between p-12 xl:p-16">
          ...
          <div className="max-w-xl text-white">
            <p className="mb-4 text-sm font-medium text-white/80">การเรียนรู้ที่วัดผลได้</p>
            <h1 className="max-w-lg text-4xl font-semibold leading-[1.18] tracking-tight xl:text-5xl">
              สร้างข้อสอบ
              <br />
              ตรวจคำตอบ และเรียนรู้ไปพร้อมกัน
            </h1>
            <p className="mt-5 max-w-lg text-base leading-7 text-white/80">
              พื้นที่เดียวสำหรับอาจารย์และผู้เรียน ตั้งแต่การออกข้อสอบ
              ไปจนถึงการทบทวนคะแนนอย่างเป็นระบบ
            </p>
          </div>
      ...
      <main className="flex min-h-screen w-full flex-1 items-center justify-center overflow-y-auto px-6 py-10 sm:px-10 md:w-1/2 md:px-12 lg:px-16">
