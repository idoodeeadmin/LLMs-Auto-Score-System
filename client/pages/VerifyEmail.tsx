        ...
        <div className="p-8 text-center space-y-6">
          {status === "loading" && (
            <div className="py-12 flex flex-col items-center">
              ...
              <h2 className="text-xl font-semibold text-slate-800">กำลังตรวจสอบข้อมูล...</h2>
            </div>
          )}
          ...
          {status === "success" && (
            <div className="py-8 flex flex-col items-center">
              ...
              <h2 className="text-2xl font-bold text-slate-800 mb-2">ยินดีด้วย!</h2>
          ...
          {status === "error" && (
            <div className="py-8 flex flex-col items-center">
              ...
              <p className="text-slate-500 mb-8">{message}</p>
              <Link to="/">
                 <Button variant="outline" className="w-full text-indigo-600 border-indigo-200 hover:bg-indigo-50 rounded-xl h-12">
