...
mappings = {
    ...
    "6.2": [
        ("ผู้สอน", [("in", "ข้อมูลคะแนนและคอมเมนต์ที่เพิ่มและแก้ไข")])
    ],
    "6.3": [
        ("ผู้สอน", [("in", "ข้อมูลการอนุมัติผลคะแนน")]),
    ...
    "7.2": [],
    "7.3": [
        ("ผู้สอน", [("in", "ข้อมูลคำขอออกรายงานสถิติ"), ("out", "ข้อมูลผลคะแนนของนักเรียน"), ("out", "ข้อมูลรายงานสรุปคะแนน"), ("out", "ข้อมูลประวัติการแก้ไขคะแนน")]),
