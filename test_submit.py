...
def test_query():
    ...
    try:
        ...
        cursor.execute("INSERT IGNORE INTO rooms (id, name, class_code, owner_id) VALUES (99999, 'Test Room', 'TEST01', 99999)")
        ...
        cursor.execute("INSERT INTO submissions (id, exam_id, student_id, status) VALUES (99999, 99999, 99999, 'submitted') ON DUPLICATE KEY UPDATE status='submitted'")
        ...
        cursor.execute(sql, (submission_id, q_id, answer_text, first_image_path, image_paths_json))
        conn.commit()
        print("Success")
